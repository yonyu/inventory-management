    ...
    addProduct(newProduct)
      ...
      .catch((error: any) => {
        setSnackbar({
          open: true,
          message:
            error?.data?.err || error?.message || "Failed to add product",
          severity: "error",
        });
    ...
    deleteProduct(selectedProduct?._id)
      ...
      .catch((error: any) => {
        setSnackbar({
          open: true,
          message:
            error?.data?.err || error?.message || "Failed to delete product",
          severity: "error",
        });
      });
  };
    ...
    updateProduct({ _id, data })
      ...
      .catch((error: any) => {
        setSnackbar({
          open: true,
          message:
            error?.data?.err || error?.message || "Failed to update product",
          severity: "error",
        });
      });
  };

...
import { Box, Typography, Button, Grid, Card, CardActionArea, CardContent, Switch } from '@mui/material';
import { Stack, styled } from '@mui/system';
import { Dashboard, Inventory, Add, ListAlt,
...
const BackgroundBox = styled(Box)(({ theme }) => ({
  backgroundImage: `url('/images/pos1.jpg')`,
...
const Home = () => {
  ...
  return (
    <BackgroundBox>
      ...
      <ContentBox>
        { /* Hero Section */}
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
                    ...
                    >
                        <Card
                            sx={{
                                ...
                                backgroundColor: '#000',
                                color: '#fff',
                                transition: 'transform 0.3s, background-color 0.3s, color 0.3s ease-in-out',
                                '&:hover': {
                                    transform: 'scale(1.05)',
